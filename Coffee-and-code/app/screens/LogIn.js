  ...
  async signInAsync() {
    try {
      ...
      if (token) {
        ...
        return await AsyncStorage.getItem("git_username").then(git_username => {
      ...
      if (token) {
        ...
        if (git_username_fromStorage) {
          console.log("git_username_fromStorage", git_username_fromStorage);
        ...
        return firebase
          ...
          .then(user => {
            ...
            return fetchGitData(git_username).then(res => {
              ...
              console.log("repos");
              return Promise.all([addNewUser(profile), addRepos(repos)])
                .then(res => {
                  console.log("res");
                  return git_username;
                })
